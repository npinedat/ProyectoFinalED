...
public class PaginaConsulta extends InterfazUsuario implements ActionListener {
    ...
    PaginaConsulta() {
        ...
        for (final Objetivo i : App.login.arbolObjetivos.toArray(App.login.arbolObjetivos.root)) {
            final JButton boton = new JButton(i.nombre);
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    for (int i = 0; i <= 23; i++) {
                        ...
                        for (int j = 1; j <= 7; j++) {
                            ...
                            ArrayList<Integer> listaHash = App.consultaUnHash(App.login, boton.getText());
                            for (int k : listaHash) {
                                if (k == ((j - 1) * 24 + i)) {
