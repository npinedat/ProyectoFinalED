...
public class PaginaPrincipal extends InterfazUsuario implements ActionListener {
    ...
    PaginaPrincipal() {
        ...
        etiqueta = new JLabel(App.login.usuario + " bienvenido a Procrastinator");
        ...
        if (App.login.arbolObjetivos.empty()) {
            ...
            etiqueta = new JLabel("El Día: " + App.nombreDia((int) Math.floor(hashCercano / 24)) + ", " + "a las: "
